...
const SingUp = () => {
  ...
  const [selectInput3, setSelectInput3] = useState(false);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.welcomeSubTitle}>Başlamak için kaydolun.</Text>
      <TextInput
      ...
      />
      <TextInput
        onEndEditing={() => setSelectInput3(false)}
        onFocus={() => setSelectInput3(true)}
        style={[
          styles.textInput,
          { borderColor: selectInput3 ? colors.darkTheme : "#BEBEBE" },
        ]}
        placeholder={"Şifre"}
      />
      ...
      <View style={styles.joinUsContainer}>
        <Text style={styles.newUserTitle}>
          Zaten üye misin?{" "}
          <Text onPress={() => navigate("Login")} style={styles.boldTitle}>
            {" "}
            Oturum aç.
          </Text>
        </Text>
